...
import "./believe-text.css"
function BelieveText() {
    return (
        <>
            <div className="believe-text-container">
                <p className="believe-text-header">
